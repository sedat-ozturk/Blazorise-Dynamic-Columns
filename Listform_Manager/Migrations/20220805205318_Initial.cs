        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecordSource = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Listform", x => new { x.Id, x.UserName });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Listform_Field", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentCourse_Student",
                        columns: x => new { x.FormId, x.UserName },
                        principalTable: "Listform",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Listform_Field_FormId_UserName",
                table: "Listform_Field",
                columns: new[] { "FormId", "UserName" });
